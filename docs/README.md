...
- [Repository vulnerability reporting](../SECURITY.md)

## Legal and Brand

- [Legal documentation index](legal/)
- [Proprietary license](../LICENSE)
- [Project notice](../NOTICE.md)
- [Commercial licensing overview](../COMMERCIAL_LICENSE.md)
...
system boundaries and accepted technical principles. ADRs record approved,
long-lived decisions. Plans are temporary execution artifacts.
