...
| [0038](0038-development-lifecycle-rehearsal.md) | Proposed | Add a fixed, operator-authenticated development route for deployed hibernation, expiry, and deletion rehearsals without changing ordinary session lifetimes. |
