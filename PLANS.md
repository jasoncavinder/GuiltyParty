...
the native phone/tablet flow and one additive server-projected vote-choice
contract before platform UI implementation.
...
3. **Next:** add bounded server-projected vote choices, contract fixtures,
   generated Swift/Kotlin models, privacy tests, and compatibility gating.
