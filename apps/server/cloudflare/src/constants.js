...
export const LIFECYCLE_REHEARSAL_ACTIVE_DURATION_MS = 45 * 1000;
export const LIFECYCLE_REHEARSAL_RETENTION_MS = 30 * 1000;
export const LIFECYCLE_REHEARSAL_INVITATION_DURATION_MS = 15 * 1000;
