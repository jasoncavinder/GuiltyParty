#!/usr/bin/env python3
"""Run the bounded Swift/Kotlin contract-generator compatibility spike."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="guiltyparty-contract-generator-spike-") as temporary:
    ...
    print(swift_result)
    print(kotlin_result)
    print("Disposable generated output removed.")
    return 0
